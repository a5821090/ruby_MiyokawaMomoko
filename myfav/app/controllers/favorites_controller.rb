...
skip_before_action :require_login, only: [:index, :show]
  ...
  private
    ...
    def favorite_params
      params.require(:favorite).permit(:name, :nickname, :birthday, :bloodtype, :birthplace, :office, :age, :gender, :height, :weight, :category, :MBTI, :link, :comment, :image, :caption,:user_id)
    end
end
